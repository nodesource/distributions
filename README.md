...
- **[Debian and Ubuntu based distributions](#debian-and-ubuntu-based-distributions)** (deb)
  ...
  - [Installation instructions](#installation-instructions-deb)
  - [Uninstall instructions](#uninstall-nsolid-or-nodejs-ubuntu--debian-packages)
- **[Enterprise Linux based distributions](#enterprise-linux-based-distributions)** (rpm)
  ...
  - [Uninstall instructions](#uninstall-nsolid-or-nodejs-enterprise-linux-packages)
