...
#
# curl -sL https://rpm.nodesource.com/setup_iojs_1.x | bash -
#   or
...
echo "+ rpm -q --whatprovides redhat-release || rpm -q --whatprovides centos-release || rpm -q --whatprovides cloudlinux-release"
DISTRO_PKG=$(rpm -q --whatprovides redhat-release || rpm -q --whatprovides centos-release || rpm -q --whatprovides cloudlinux-release)
echo "+ uname -m"
UNAME_ARCH=$(uname -m)
...
if [[ $DISTRO_PKG =~ ^redhat- ]] || [[ $DISTRO_PKG =~ ^centos- ]] || [[ $DISTRO_PKG =~ ^cloudlinux- ]]; then
    DIST_TYPE=el
